...
export default function HighLight(props) {
  ...
  return (
    <div className={`${isCompact ? "container-margin-compact section-y" : ""}`}>
      <div className="flex justify-center w-full">
        <div className="flex flex-col max-w-[500px] min-[769px]:max-w-none w-full md:flex-row">
          ...
          >
            <h2 className="text-3xl leading-8 text-center md:text-left md:text-3xl md:leading-7 lg:text-5xl text-white-shade-100 font-markaziText">
              {title}
            </h2>
            <p className="text-center sm:text-sm md:text-left md:text-base text-white-shade-200 lg:text-base">
              {description}
            </p>
          </div>
        </div>
