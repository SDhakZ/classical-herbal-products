...
export default function ProductDirection({ direction }) {
  return (
    <div className="padding-lg container-margin-compact">
      ...
      <div className="flex flex-wrap items-center justify-center gap-8 mt-10 sm:gap-16 sm:mt-14 md:mt-16">
        {direction.map((direction, index) => (
          <div
            className="px-2 overflow-hidden bg-primary-beige-200 rounded-[24px]  h-full min-h-[300px] flex flex-col items-center justify-start border-[#968261] gap-2 border-4  relative pt-2 pb-4 w-full max-w-[280px]"
            key={index}
          >
            <div className="w-10  absolute top-3 flex items-center justify-center left-3 h-10 border-4 rounded-full border-[#968261]">
